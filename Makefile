...
IMG ?= docker.io/digitalocean/do-operator:${IMG_TAG}
...
test: manifests generate fmt vet envtest ## Run tests.
	GOTOOLCHAIN=go1.25.3+auto ACK_GINKGO_DEPRECATIONS=1.16.5 KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) -p path)" go test ./... -coverprofile cover.out
