...
func (f *FakeDatabasesService) Delete(_ context.Context, dbUUID string) (*godo.Response, error) {
	...
	return &godo.Response{Response: &http.Response{StatusCode: http.StatusNotFound}}, errors.New("not found")
}
...
// GetUser ...
func (f *FakeDatabasesService) GetUser(_ context.Context, _ string, _ string) (*godo.DatabaseUser, *godo.Response, error) {
	panic("not implemented")
}
...
// CreateUser ...
func (f *FakeDatabasesService) CreateUser(_ context.Context, _ string, _ *godo.DatabaseCreateUserRequest) (*godo.DatabaseUser, *godo.Response, error) {
	panic("not implemented")
}

// DeleteUser ...
func (f *FakeDatabasesService) DeleteUser(_ context.Context, _ string, _ string) (*godo.Response, error) {
	panic("not implemented")
}
